...
export const SLUG_ALIASES: Record<string, string> = {
  ...
  "resize-pdf": "merge-pdf",
  "scale-pdf": "merge-pdf",
  "pdf-resize": "merge-pdf",
  "pdf-scale": "merge-pdf",
  "resize-pdf-pages": "merge-pdf",
  "scale-pdf-pages": "merge-pdf",
  "pdf-resizer": "merge-pdf",
